...
import Contact from '../component/Contact'; // Adjust the import path based on your project structure
import Footer from '../component/Footer'; // Correctly import Footer component
      ...
      <section className="my-8 bg-gray-800 bg-opacity-50 dark:bg-gray-100 dark:bg-opacity-50 text-gray-100 dark:text-gray-800">
        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
          <svg
            ...
            viewBox="0 0 512 512"
            fill="currentColor"
            className="w-16 h-16 text-violet-400 dark:text-violet-600"
          >
          ...
          <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-gray-300 dark:text-gray-700">
